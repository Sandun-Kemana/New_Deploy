        ...
        <Spacings.Stack scale="l">
          ...
          >
            ...
            <InfoCard
              ...
              linkTo={`${match.url}/quotes`}
            />
            <InfoCard
              title={intl.formatMessage(messages.cardQuotesFormTitle)}
              content={intl.formatMessage(messages.cardQuotesFormContent)}
